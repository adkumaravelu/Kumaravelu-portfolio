...
<section id="projects" className="project-section">
      ...
      <div className="project-grid">
        ...
        <div className="project-card">
          ...
          <a href="https://your-project-link.com" target="_blank" rel="noopener noreferrer" className="project-button">
            🔗 View Project
          </a>
        </div>
        ...
        <div className="project-card">
          ...
          <a href="https://your-portfolio-link.com" target="_blank" rel="noopener noreferrer" className="project-button">
            🔗 View Project
          </a>
        </div>
